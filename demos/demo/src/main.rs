    ...
    fn ui(&mut self, ui: &mut egui::Ui, _frame: &mut eframe::Frame) {
        ...
        egui::Panel::left("left_panel")
            ...
            .show(ui, |ui| {
                self.vertical_stack
                    ...
                    .body(ui, {
                        |body| {
                            for (panel_index, enabled) in self
                                .panel_order
                                .iter()
                                .zip(self.enabled_panels)
                            {
                                if !enabled {
                                    continue;
                                }
        ...
        egui::CentralPanel::default().show(ui, |ui| {
            ...
            Frame::group(&Style::default()).show(ui, |ui| {
                ...
                for (index, (panel_index, enabled)) in self
                    .panel_order
                    .iter_mut()
                    .zip(self.enabled_panels.iter_mut())
                    .enumerate()
                {
            ...
            Frame::group(&Style::default()).show(ui, |ui| {
                ...
                ui.add(
                    ...
                    .text("Min panel height"),
                );

                let mut max_panel_height_enabled = self
                    .vertical_stack_settings
                    .max_panel_height
                    .is_some();
                if ui
                    .checkbox(&mut max_panel_height_enabled, "Enable max panel height")
                    .changed()
                {
                    match max_panel_height_enabled {
                        true => {
                            self.vertical_stack_settings
                                .max_panel_height = Some(100.0)
                        }
                        false => {
                            self.vertical_stack_settings
                ...
                ui.add_enabled_ui(max_panel_height_enabled, |ui| {
                    if let Some(max_panel_height) = &mut self
                        .vertical_stack_settings
                        .max_panel_height
                    {
                ...
                let mut max_height_enabled = self
                    .vertical_stack_settings
                    .max_height
                    .is_some();
                if ui
                    .checkbox(&mut max_height_enabled, "Enable max height")
                    .changed()
                {
